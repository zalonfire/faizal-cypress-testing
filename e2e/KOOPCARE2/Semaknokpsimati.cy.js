describe('TK- Semak no kp si mati', () => {
  beforeEach(() => {
...
//tarikh mati 
cy.get('#ContentPlaceHolder1_TarikhKematian').type('22/1/2025');//command ni kalau tidak layak
//tarikh mati tidak layak
// cy.get('#ContentPlaceHolder1_TarikhKematian').type('22/1/2020');
//semak
