describe('Selenggara Tabung Sumbangan', () => {
  ...
  it('should log in and navigate successfully', () => {
    ...
    // ✅ Checkpoint 2: Tambah Sub Kategori Baru
    cy.get('#ContentPlaceHolder1_GridTabung_imgbtnNavigate_0').click();
    cy.get('#ContentPlaceHolder1_GridTabung_txtAddSubKat').type(subKategoriBaru);
    cy.get("#ContentPlaceHolder1_GridTabung_txtAddRM")
      .clear()
      .type(jumlahSumbangan);
    cy.get('#ContentPlaceHolder1_GridTabung_lbtnAdd').click();
    cy.wait(10000);

    // // ✅ Checkpoint 3: Kemaskini Sub Kategori
    // cy.get('#ContentPlaceHolder1_GridSubTabung_imgbtnEdit_0', { timeout: 20000 }) 
    // .should('exist')
    cy.get('#ContentPlaceHolder1_GridSubTabung_imgbtnEdit_0', { timeout: 60000 })
    .should('exist')
    .should('be.visible')
    .click({ force: true });
  
  
    cy.get('#ContentPlaceHolder1_GridSubTabung_txtUpdateSubKat')
      .clear()
      .type(`${subKategoriBaru} Updated`);
    cy.get('#ContentPlaceHolder1_GridSubTabung_txtUpdateRM')
      .clear()
      .type(jumlahSumbangan);
    cy.get('#ContentPlaceHolder1_GridSubTabung_imgbtnUpdate_0').click();
    cy.wait(10000);
  });
});
