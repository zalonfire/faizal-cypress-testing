describe('tabung bencana alam lebih atau = 6 bulan ', () => {
  beforeEach(() => {
  ...
  it('should log in and navigate successfully', () => {
    ...
    cy.get('#ContentPlaceHolder1_bnd_modules_gt_lnk_0 > div > div > div.ch-info-front.ch-img-1')
      ...
      .click();
//SAR 
cy.get("#ContentPlaceHolder1_JOCcaw option")
  .should("have.length.greaterThan", 1); // Wait for options to exist

cy.get("#ContentPlaceHolder1_JOCcaw")
  .should("be.visible")
  .select("SAR GONG BADAK", { force: true });

  

//no kp baru
cy.get('#ContentPlaceHolder1_Txtnokp').type('570306035754', { force: true });
//carian
...
//nama pemohon
cy.get('#ContentPlaceHolder1_txtnama2').type('ZAINAB BINTI MAT');
